...
class DataAnalysisTool:
    ...
    def generate_pie_chart(self):
        ...
        # 如果有小扇区，添加"其他"类别
        if other_size > 0:
            main_labels.append("其他" if not self.use_english else "Other")
        ...
        # 设置标题
        chart_title = '产品类型分布图' if not self.use_english else 'Product Type Distribution'
        ...
        ax.legend(wedges, legend_labels,
                  title="产品类型" if not self.use_english else "Product Types",
